...
$categoriesForNavigation = getCategoriesForNavigation($connection);

/**
 * This is function for all categories
 * @return array
 */
function getCategoriesForNavigation($connection, $categoryId = NULL){
    $categories = [];
    ...
    try {
        ...
        // Make query string
        $sqlQueryString = "
            SELECT categories.id, categories.name, count(categories.id) as total
            FROM products 
